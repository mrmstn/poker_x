defmodule PokerXWeb.UserLive.Row do
...
defmodule PokerXWeb.UserLive.IndexAutoScroll do
  use Phoenix.LiveView

  alias PokerXWeb.UserLive.Row
  ...
  defp fetch(%{assigns: %{page: page, per_page: per}} = socket) do
    assign(socket, users: PokerX.Accounts.list_users(page, per))
  end
